    ...
    if ((dir = opendir(caminho_base.c_str())) != NULL)
    {
        while ((ent = readdir(dir)) != NULL)
        {
            ...
            if (nome_pasta.find("instancia_") != string::npos)
            {
                ...
                // Avaliacao da solucao inicial (FIFO)
                ...
                // Salva o relatório detalhado dos grafos em um arquivo
                ...
                if (arquivo_relatorio.is_open())
                {
                    ...
                    arquivo_relatorio << "Comprimento do Caminho Maximo (Makespan): " << makespan_final_txt << "\n\n";

                    arquivo_relatorio << "Caminho Maximo Global (Elemento Minimal ao Maximal):\n -> ";
                    ...
                    // Caminhos maximos por final de linha (Job)
                    arquivo_relatorio << "Caminhos Maximos para os Finais de Linha (Ultimas Ops de cada Job):\n";
